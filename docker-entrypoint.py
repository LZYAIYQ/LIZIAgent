#!/usr/bin/env python3
"""Docker entrypoint for LZAgent.

Responsibilities:
  * Ensure persistent directories exist.
  * Seed workspace with defaults without overwriting user data.
  * Start the uvicorn server bound to LZAGENT_HOST:LZAGENT_PORT.
"""
...
def main() -> int:
    os.environ.setdefault("LZAGENT_HOST", "0.0.0.0")
    os.environ.setdefault("LZAGENT_PORT", "8020")
    ...
    command = sys.argv[1:] or [
        ...
        "backend.app:app",
        "--host",
        os.environ["LZAGENT_HOST"],
        "--port",
        os.environ["LZAGENT_PORT"],
    ]
